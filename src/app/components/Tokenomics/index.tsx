...
export const Tokenomics = () => {
  return (
    <div
      id="tokenomics"
      className="bg-[url('/Vectors/Tokenomics.png')] bg-contain bg-no-repeat w-100   relative flex justify-center"
    >
      <Container>
        <h1 className="text-txt_brown text-2xl lg:text-5xl font-bold mt-16 w-full">
          Tokenomics
        </h1>
        <div className="bg-[url('/Vectors/wood-sign.svg')] lg:bg-[url('/Vectors/wood-sign.png')] bg-contain bg-no-repeat lg:w-[60vw] mt-5 lg:mt-12 h-56 lg:h-80 mx-auto relative flex items-center justify-center bg-center">
        ...
        <section id="who-is" className="relative py-10 xl:mt-[600px]">
