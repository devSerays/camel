...
const Hero = () => {
  return (
    <div className="bg-[url('/Vectors/hero-sm.svg')] md:bg-[url('/Vectors/hero.svg')] h-[550px] bg-bottom bg-cover lg:bg-cover bg-no-repeat w-100 relative lg:h-[140vh] bg-[#FDB93C]">
      <Header />
